"""
This module provides a default timetable_module and functions to retrieve information from it.

Classes:
    - Subject: Represents a subject with attributes like name, lecturer, room, etc.
    - Timetable: Represents a weekly timetable_module with subjects scheduled for each day.

Functions:
    - get_timetable(): Returns a default timetable_module with sample subjects for each day.
    - get_all_subjects(): Returns a list of all non-null subjects from the default timetable_module.
"""

import array

from src.timetable_module.subject import Subject
...
def get_timetable() -> Timetable:
    """
    Get a default timetable_module with sample subjects for each day of the week.
